...
export const logout = () => request.post('/auth/logout') as Promise<any>;
export const refreshToken = () => request.post('/auth/refresh') as Promise<any>;
...
export const updateMe = (data: any) => request.post('/auth/update-me', data) as Promise<any>;
